  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="w-48 group relative flex items-center gap-2 px-4 py-2.5 bg-white/5
        rounded-lg transition-all duration-200 border border-white/10 hover:border-gray-700"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-full min-w-[240px] bg-[#0f0f0f] 
